...
export const IconInvoice = (p) => (
  <svg viewBox="0 0 24 24" fill="none" {...p}>
    <path d="M6 2.5h9l3 3V21a.5.5 0 0 1-.5.5h-11A.5.5 0 0 1 6 21V3a.5.5 0 0 1 .5-.5Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
...
export const IconMark = (p) => (
  <svg viewBox="0 0 24 24" fill="none" {...p}>
    <path d="M2.5 19.5 8.5 8l3.6 5.7L15.5 9l6 10.5" stroke="#eafff5" strokeWidth="1.6" strokeLinejoin="round" strokeLinecap="round" fill="none" />
  </svg>
);
